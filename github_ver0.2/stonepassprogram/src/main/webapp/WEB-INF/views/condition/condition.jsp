...
<body>
	<article>
		<div class="container">
			...
			<label class="switch-button"> <input value="" type="checkbox"
				id="checkAll" name="checkall" /> <span class="onoff-switch"></span>
			</label>
							...
							<c:when test="${!empty boardList}">
								...
								<c:forEach var="list" items="${boardList}">
									...
									<tr>
										...
										<td><c:out value="${list.bid}"></c:out> <label
											class="switch-button"> <input class="chkselect" value="${list.bid}"
												type="checkbox" onchange="kdw(this)" id="checkBoxId"
												name="checkBoxId" /> <span class="onoff-switch"></span>
										</label></td>
										<td>
										<c:if test="${list.bid ne null}">
