...
$(document).on('click', '#orga_submit', function(e){	
...
<body>
	<section id="container">
		...
		<form target="popup_window" id="form_orga" name="form_orga" method="post" action="/condition" >
			...
			<div class="form-group has-feedback">
				<button class="btn btn-success" type="submit" id="orga_submit">기관등록</button>
