...
public class RestConditionController {
	...
	public String curl(@RequestParam("values") String values, @RequestParam("bid") String bid, ConditionVO conditionvo,Model model)
			throws Exception {
	...
	public String[] curlArray(@RequestParam(required = false, defaultValue = "null", 
	value="bidArray" ) int[] bidArray, @RequestParam(required = false,defaultValue = "null", 
	value="values") String values, ConditionVO conditionvo,Model model)
			throws Exception {
