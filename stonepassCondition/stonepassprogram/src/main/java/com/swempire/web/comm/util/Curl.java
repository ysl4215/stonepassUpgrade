...
public class Curl {
	 ...
	 * 
	 * Curl curl = new Curl(); System.out.println(curl.get(
	 * "https://login.daegu.ac.kr/stonepass/sp/v1/fido/facets", null));
	 * 
	 * }
	 */
	 ...
	 * @throws Exception 
	 */
	public String connGet(String strUrl, String[] headers)   {
		...
		try {
			...
			/*
			 * logger.info("[Get] Url::: " + strUrl); logger.info("[Get] Method::: " +
			 * hurlc.getRequestMethod()); logger.info("[Get] Conn Timeout::: " +
			 * hurlc.getConnectTimeout()); logger.info("[Get] Read Timeout::: " +
			 * hurlc.getReadTimeout()); logger.info("[Get] Headers::: " +
			 * hurlc.getRequestProperties().toString());
			 */
			// 서버 연결
